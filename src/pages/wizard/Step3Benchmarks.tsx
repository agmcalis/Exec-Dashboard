...
export default function Step3Benchmarks({ state, onChange, onNext, onBack }: Props) {
  const visibleBenchmarks = BENCHMARK_DEFS.filter(
    b => !b.scopeExclude || !state.level || !b.scopeExclude.includes(state.level)
  )
